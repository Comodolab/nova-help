...
Nova.booting(function (Vue, router) {
    Vue.component('index-help', __webpack_require__(3));
    Vue.component('detail-help', __webpack_require__(6));
    Vue.component('form-help', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c("div", [
    _vm.field.icon
      ? _c("div", {
          staticClass: "pr-4 comodolab-help-field-icon-container inline-block",
          class: _vm.iconClass,
          attrs: {
            "data-balloon": _vm.field.message.replace(/<(?:.|\n)*?>/gm, "")
          },
          domProps: { innerHTML: _vm._s(_vm.field.icon) }
        })
      : _vm._e()
  ])
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__FormField__ = __webpack_require__(9);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: { FormField: __WEBPACK_IMPORTED_MODULE_0__FormField___default.a }
});
...
var render = function() {
  ...
  return _c("form-field", {
    class: { "help-field-full-width": _vm.field.fullWidthOnDetail },
    attrs: { field: _vm.field, context: "details" }
  })
}
var staticRenderFns = []
render._withStripped = true
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        shownOnDetails: function shownOnDetails() {
...
var render = function() {
  ...
  return _c("field-wrapper", [
    _vm.field.sideLabel
      ? _c(
          "div",
          { class: _vm.shownOnDetails ? "w-1/4 py-6" : "w-1/5 py-6 px-8" },
          [
            _c("label", { staticClass: "inline-block text-80 leading-tight" }, [
      ...
      : _vm._e(),
    _vm._v(" "),
    _c("div", { staticClass: "py-6 px-8 w-full", class: _vm.fieldClasses }, [
      _c("div", { staticClass: "flex comodolab-help-field" }, [
        _vm.field.icon
          ? _c("div", {
              staticClass: "pr-4 comodolab-help-field-icon-container",
              domProps: { innerHTML: _vm._s(_vm.field.icon) }
            })
          : _vm._e(),
        _vm._v(" "),
        _c("div", [
          !_vm.field.sideLabel && _vm.field.name
            ? _c("h4", { class: { "mb-2": _vm.field.message } }, [
                _vm._v(_vm._s(_vm.field.name))
              ])
            : _vm._e(),
          _vm._v(" "),
          _c("div", { class: _vm.messageClasses }, [
            _vm.field.asHtml
              ? _c("div", {
                  domProps: { innerHTML: _vm._s(_vm.field.message) }
                })
              : _c("div", [_vm._v(_vm._s(_vm.field.message))])
          ])
        ])
      ])
    ])
...
var update = __webpack_require__(21)("e5d016e6", content, false, {});
